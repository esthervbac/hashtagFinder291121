...
export default function Results() {
  ...
  useEffect(() => {
    axios
      ...
      .then((resp) => {
        let hash = resp.data.records.map((record) => {
          return {
      ...
      <div className="resultsHero">
        <div className="resultsList">
          ...
          <table>
            <thead>
              <tr>
                <th className="tableHeaderLeft">Hashtag</th>
                <th className="tableHeaderMiddle">Data</th>
                <th className="tableHeaderRight">Hora</th>
              </tr>
            </thead>
            <tbody>
              {squad.map((hash) => (
                <tr>
                  ...
                  <td className="tableMiddle">{formatDate(hash.data)}</td>
                  <td className="tableRight">{formatHour(hash.data)}</td>
                </tr>
              ))}
            </tbody>
          </table>
